...
import { InputKeys } from '../../../../cartesi-backend/test-frontend-console/src/commands/types'
import {
  connect,
  Args as ConnectArgs,
  builder as connectBuilder,
} from '../../../../cartesi-backend/test-frontend-console/src/connect'
import {
  rollups,
  Args as RollupsArgs,
  builder as rollupsBuilder,
} from '../../../../cartesi-backend/test-frontend-console/src/rollups'
 ...
 */
export const getInputKeys = (receipt) => {
